        ...
        {accounts.map((account) => {
          ...
          return (
            <button
              className={
                isActive
                  ? "bg-[#8493b3] px-4 py-3 text-left font-semibold text-[#202136]"
                  : "border border-transparent px-4 py-3 text-left text-muted hover:border-[#71869f] hover:bg-[#30324c]"
              }
              key={account.id}
            ...
            >
              ...
              <span className={isActive ? "block text-xs text-[#33334b]" : "block text-xs text-muted"}>
